...
func TestDefaultPolicyCatalogCompleteAndPublished(t *testing.T) {
	...
	for _, key := range []string{"runtime.publication_handoff.v1", "workflow.execution.v1", "automation.execution.v1", "scheduler.execution.v1", "report.export.v1", "cache.dictionary.v1"} {
		if byKey[key] != 1 {
